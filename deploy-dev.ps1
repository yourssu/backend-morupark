...
terraform -chdir="./terraform_temp/public-subnet" init
terraform -chdir="./terraform_temp/public-subnet" plan

Write-Host "2. Terraform을 사용하여 인프라를 배포합니다..." -ForegroundColor Green
# -auto-approve 옵션은 확인 질문 없이 바로 실행합니다.
terraform -chdir="./terraform_temp/public-subnet" apply -auto-approve
